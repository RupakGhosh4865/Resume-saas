...
class PDFGenerator(FPDF):
    ...
    def footer(self):
        ...
        self.cell(0, 10, f"Generated by AI Resume Optimizer - Page {self.page_no()}", align="C")
    ...
    def generate_resume_pdf(self, content):
        ...
        self.cell(0, 10, content.get("full_name", "Resume"), ln=True, align="C")
        
        self.set_font("helvetica", "", 9)
        contact = content.get("contact", {})
        contact_str = f"{contact.get('email')} | {contact.get('phone')} | {contact.get('location')}"
        self.cell(0, 5, contact_str, ln=True, align="C")
        ...
        if content.get("summary"):
            ...
            self.multi_cell(0, 5, content.get("summary"))
            self.ln(5)
        ...
        if content.get("experience"):
            ...
            for exp in content.get("experience"):
                ...
                self.cell(0, 5, f"{exp.get('role')} at {exp.get('company')}", ln=False)
                self.set_font("helvetica", "I", 9)
                self.cell(0, 5, exp.get("duration"), ln=True, align="R")
                
                self.set_font("helvetica", "", 9)
                for pt in exp.get("points", []):
                    self.multi_cell(0, 5, f"- {pt}")
                self.ln(3)
        ...
        if content.get("projects"):
            ...
            for proj in content.get("projects"):
                self.set_font("helvetica", "B", 10)
                self.cell(0, 5, proj.get("title"), ln=False)
                self.set_font("helvetica", "I", 9)
                self.cell(0, 5, proj.get("tech"), ln=True, align="R")
        ...
        if content.get("skills"):
            ...
            self.multi_cell(0, 5, f"Languages: {', '.join(skills.get('languages', []))}")
            self.multi_cell(0, 5, f"Frameworks: {', '.join(skills.get('frameworks', []))}")
            self.multi_cell(0, 5, f"Tools: {', '.join(skills.get('tools', []))}")
            self.ln(5)
        ...
        if content.get("education"):
            ...
            for edu in content.get("education"):
                self.set_font("helvetica", "B", 10)
                self.cell(0, 5, edu.get("institution"), ln=False)
                self.set_font("helvetica", "I", 9)
                self.cell(0, 5, edu.get("duration"), ln=True, align="R")
                self.set_font("helvetica", "", 9)
                self.cell(0, 5, edu.get("degree"), ln=True)
                if edu.get("details"):
                    self.multi_cell(0, 5, edu.get("details"))
                self.ln(3)
